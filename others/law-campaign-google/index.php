            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">                   
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <img src="img/banner_1.jpg" alt="isbr_mba" />
                    </div>
<!--                    <div class="item">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 padding_20">                    
                  <form class="form-horizontal" method="post" id="conform" name="conform" action="connect.php" onSubmit="return saveCustDetails()">
                    ...
                    <div class="form-group col-sm-12">
                        <h4 class="form-title">Select Courses</h4>
                        <div class="checkbox">
                          <label><input type="checkbox" name="courses[]" id="chk1" value="BBA LLB">BBA LLB</label>
                        </div>
                        <div class="checkbox">
                          <label><input type="checkbox" name="courses[]" id="chk2" value="BCOM LLB">BCOM LLB</label>
                        </div>
                        <div class="checkbox">
                          <label><input type="checkbox" name="courses[]" id="chk3" value="BA LLB">BA LLB</label>
                        </div>
                        <p class="error_msg" id="error_courses"></p>
                    </div>
        ...
        <div class="row text-cente padding_20">
            <div class="col-sm-12 col-md-12  div_outcome">
                ...
                <ul>
                    ...
                    <li>The Only Law College having a Tie-up with National Law University, Bangalore.</li>
                    <li>Internship opportunities with Biggest Law Firm In India, Singhania & Co.</li>
