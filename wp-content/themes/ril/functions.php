...
function twentythirteen_widgets_init() {
	...
	/* Footer widget code end here */
	/* Home page widget code start here */
	if ( function_exists('register_sidebar') )
  	register_sidebar(array(
		'name' => 'Home Content I',
		'before_widget' => '<div class = "widgetizedArea">',
	...
	/* Home page widget code end here */
	/* own sidebar widget code end here */
	if ( function_exists('register_sidebar') )
  	register_sidebar(array(
		'name' => 'own sidebar',
		'before_widget' => '<div class = "widgetizedArea">',
	...
	/* own sidebar widget code end here */
	/* academic sidebar widget code end here */
	if ( function_exists('register_sidebar') )
  	register_sidebar(array(
...
function admin_menu_add_external_link_top_level() {
    ...
    add_menu_page( 'admin_menu_add_external_link_top_level', 'Admission List', 'read', $menu_slug, '', 'icon', $menu_pos );

    // replace the slug with your external url
    $menu[$menu_pos][2] = "http://renaissancelawcollege.com/admission_list.php";
}
...
// button redirection
echo '<div>';
echo '<button style="background: #2F2F2F; font-style: normal; font-weight: 500; font-size: 14px; line-height: 21px;text-align: center; color: #FFFFFF; padding: 12px 10px;margin: 31px 0px 0px 0px;cursor: pointer;"><a target="_blank" href="https://graffersid.com/renaissa/student-details-table/" style="border: none;outline: none;color:#ffffff;">Student Details</a></button>';
echo '</div>';
