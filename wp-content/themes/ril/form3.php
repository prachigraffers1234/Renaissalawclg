...
<td><td><form action="" method="post" name="myform" id="myform" onsubmit="MM_validateForm('name','','R','email','','RisEmail');return document.MM_returnValue">
              <table width="200%" height="170" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top"><table width="240" height="450" 
		  ...
		  if($msg!="Right") { echo $msg; }?>
                      ...
                      <tr>
                        <td  height="33"  colspan="3" align="right" valign="top" class="contacttxt"><input id="phone1" size="10" name="phone" type="text" class="form"  value="<?php echo $phone;?>" onkeyup="allow_character(this);" placeholder="Phone"/></td>
                      </tr>
                      <tr>
                        <td  height="33"  colspan="3" align="right" valign="top" class="contacttxt"><input id="Alternate No" size="10" name="Alternate No" type="text" class="form"  value="<?php echo $phone1;?>" onkeyup="allow_character(this);" placeholder="Alternate No"/></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                        <td  height="33"  colspan="3" align="right" valign="top" class="contacttxt"><select name="courses" id="courses" class="form">
