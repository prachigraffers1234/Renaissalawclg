...
*/
/*
Template Name: Academic Template
*/
get_header(); ?>
 <?php
...
<div class="wrapper row3">
  <div role="main" class="container">
    ...
    <div id="sidebar_1" class="sidebar one_quarter">
      ...
      <?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar("academic sidebar") ):?><?php endif; ?>
...
<button type="submit" class="btn btn-primary pull-right" style="margin:8px">Send</button>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tbody >
        <tr>
          <td align="center" valign="middle" style="background-color:rgb(37, 41, 45); border:none"><img src="/wp-content/themes/ril/images/whatsapp.png"> <strong style="color:#fff;">+91 9876543210</strong></td>
        </tr>
      </tbody>
    </table>
  </div>
